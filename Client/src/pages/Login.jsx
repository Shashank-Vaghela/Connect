...
import { bgGradient, gradient2 } from "../constants/color";
        ...
        >
          {isLogin ? (
            ...
            <form onSubmit={handleSignUp} style={{ width: '100%', marginTop: '1rem' }}>
              <Stack direction="column" alignItems="center" spacing={1} marginBottom={1}>
              ...
              <Typography textAlign="center" my={1}>OR</Typography>
